...
void vxaddint256(size_t n, const uint64_t x[][4], const uint64_t y, uint64_t z[][4]);
...
int main() {
  ...
  uint64_t y = 1;
  uint64_t z[2][4];
  uint64_t e[2][4] = {{0x0000000000000002, 0x0000000000000002, 0x0000000000000003, 0x0000000000000004},
